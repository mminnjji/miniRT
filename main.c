...
t_scene	*scene_init(void)
{
    ...
    scene->camera = camera(&scene->canvas, point3(0, 0, 0), point3(0,0,-5), vec3(0,1,-1), 90);
    world = object(SP, sphere(point3(-3, 0, -7), 1), color3(0.5, 0.5, 0));
	oadd(&world, object(SP, sphere(point3(0, -2000, -5), 1999), color3(1, 1, 1)));
    oadd(&world, object(SP, sphere(point3(3, 0, -5), 1), color3(0, 0.5, 0.5)));
    oadd(&world, object(P, plane(point3(0, -1, -5), vec3(0, 1, 0)), color3(1, 0, 0)));
