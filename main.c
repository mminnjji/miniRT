...
t_scene	*scene_init(void)
{
    ...
    world = object(SP, sphere(point3(-3, 0, -5), 1), color3(0.9, 0.6, 0));
	oadd(&world, object(SP, sphere(point3(0, -2000, -5), 1999), color3(1, 1, 1)));
    oadd(&world, object(SP, sphere(point3(3, 0, -5), 1), color3(0.2, 0.5, 0.9)));
	...
	scene->world = world;
    lights = object(LIGHT_POINT, light_point(point3(-10, 10, -7), color3(1, 1, 1), 0.7), color3(0, 0, 0));
    scene->light = lights;
    ka = 0.1; 
